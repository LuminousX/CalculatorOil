...
public class DetailCar {
    ...
    public String[] type_car = {"ยี่ห้อรถยนต์", "Bmw", "Chevrolet", "Ford", "Foton", "Honda", "Isuzu", "Mazda", "Mercedes-Benz", "Mg", "Mini", "Mitsubishi", "Nissan", "Suzuki", "Tata", "Toyota"};

    public String[] bmw = {"รุ่น", "118i M Sport", "118i Sport", "318i", "320d", "320d Celebration Edition", "320d GT Celebration Edition", "320d GT Luxury", "320d GT Sport", "320d Luxury",
    ...
    public double[] bmw_combined = {0, 20, 20, 20, 27, 27, 27, 27, 27, 27,
    ...
    public double[] bmw_town = {0, 16.1, 16.1, 16.1, 23.3, 23.3, 23.3, 23.3, 23.3, 23.3,
    ...
    public double[] bmw_countryside = {0, 23.3, 23.3, 23.3, 29.4, 29.4, 29.4, 29.4, 29.4, 29.4,
    ...
    public String[] chevrolet = {"รุ่น", "CAPTIVA 2.0 DSL AWD LTZ", "CAPTIVA 2.0 DSL FWD LSX", "CAPTIVA 2.0 DSL FWD LTZ", "CAPTIVA 2.0L DSL AWD AT LTZ", "CAPTIVA 2.0L DSL FWD AT LSX",
    ...
    public double[] chevrolet_combined = {0, 11.6, 13.5, 13.5, 11.6, 13.5, 13.5, 9.8, 10.3, 9.8, 10.3,
    ...
    public double[] chevrolet_town = {0, 8.8, 10.5, 10.5, 8.8, 10.5, 10.5, 7.5, 7.6, 7.5, 7.6,
    ...
    public double[] chevrolet_countryside = {0, 14.1, 16.1, 16.1, 14.1, 16.1, 16.1, 12, 12.8, 12, 12.8,
    ...
    public String[] suzuki = {"รุ่น", "CELERIO GA 1.0L MT", "CELERIO GL 1.0L CVT", "CELERIO GLX 1.0L CVT", "CIAZ GA MT", "CIAZ GL CVT",
    ...
    public double[] suzuki_combined = {0, 21.3, 20.8, 20.8, 20, 20, 20, 20, 20, 20.4, 20.4,
            20.4, 20.4, 20.4};

    public double[] suzuki_town = {0, 17.2, 17.2, 17.2, 16.1, 16.1, 16.1, 16.1, 16.1, 16.7, 16.7,
            16.7, 16.7, 16.7};

    public double[] suzuki_countryside = {0, 24.4, 23.8, 23.8, 23.3, 23.3, 23.3, 23.3, 23.8, 22.7, 22.7,
            22.7, 22.7, 22.7};

    public String[] toyota = {"รุ่น", "Avanza 1.5E A/T", "Avanza 1.5E M/T", "Avanza 1.5G A/T", "Avanza 1.5S A/T", "Camry 2.0G",
    ...
    public double[] toyota_combined = {0, 14.7, 14.9, 14.7, 14.7, 13.2, 13.2, 12.5, 17.9, 17.9, 16.1,
    ...
    public double[] toyota_town = {0, 11.8, 11.8, 11.8, 11.8, 9.6, 9.6, 9, 20.4, 20.4, 12.2,
    ...
    public double[] toyota_countryside = {0, 17.2, 17.5, 17.2, 17.2, 16.7, 16.7, 16.4, 16.7, 16.7, 20,
    ...
    public String[] nissan = {"รุ่น", "ALMERA 1.2L E CVT", "ALMERA 1.2L E MT", "ALMERA 1.2L E SPORTECH CVT", "ALMERA 1.2L EL CVT", "ALMERA 1.2L NISMO E CVT",
    ...
    public double[] nissan_combined = {0, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,
    ...
    public double[] nissan_town = {0, 16.7, 15.6, 16.7, 16.7, 16.7, 16.7, 16.7, 15.6, 16.7, 16.7,
    ...
    public double[] nissan_countryside = {0, 22.2, 23.3, 22.2, 22.2, 22.2, 22.2, 22.2, 23.3, 22.2, 22.2,
    ...
    public String[] ford = {"รุ่น", "EcoSport 1.5L Ambiente AT", "EcoSport 1.5L Titanium AT", "EcoSport 1.5L Trend AT", "EcoSport 1.5L Trend Black Edition AT", "Everest 2.2L AT 4x2 Titanium",
    ...
    public double[] ford_combined = {0, 15.4, 15.4, 15.4, 15.4, 13.2, 11.4, 17.5, 17.5, 17.5, 14.3,
    ...
    public double[] ford_town = {0, 12.2, 12.2, 12.2, 12.2, 10.4, 8.5, 13.3, 13.3, 13.3, 9.9,
    ...
    public double[] ford_countryside = {0, 18.2, 18.2, 18.2, 18.2, 15.4, 13.9, 21.3, 21.3, 21.3, 19.2,
    ...
    public String[] mazda = {"รุ่น", "BT-50 PRO : DBL 2.2 Hi-Racer", "BT-50 PRO : DBL 2.2 Hi-Racer ABS", "BT-50 PRO : DBL 2.2 Hi-Racer ABS AT", "BT-50 PRO : DBL 2.2 S", "BT-50 PRO : DBL 2.2 V ABS",
    ...
    public double[] mazda_combined = {0, 13.2, 13.2, 10.1, 14.1, 14.1, 10.6, 13.3, 14.7, 14.7, 12.2,
    ...
    public double[] mazda_town = {0, 11.1, 11.1, 7.9, 11.6, 11.6, 8.3, 11.5, 11.9, 11.9, 10.4,
    ...
    public double[] mazda_countryside = {0, 14.7, 14.7, 11.9, 16.1, 16.1, 12.7, 14.9, 16.9, 16.9, 13.7,
    ...
    public String[] mitsubishi = {"รุ่น", "Attrage GLS (CVT)", "Attrage GLS-LTD (CVT)", "Attrage GLX (CVT)", "Attrage GLX (MT)", "Mirage GL",
    ...
    public double[] mitsubishi_combined = {0, 23.3, 23.3, 23.3, 23.3, 23.3, 23.3, 23.3, 23.8, 23.3, 13.5,
            13.5, 13.3, 13.3, 0, 13.9, 15.2, 13.3, 14.9, 13.5, 15.2, 9.3,
            13.9, 13.9, 15.2, 13.7, 15.2, 9.3, 13.9, 12.8, 11.8};

    public double[] mitsubishi_town = {0, 20.4, 20.4, 20.4, 19.6, 18.5, 20, 20, 20, 18.5, 11.1,
            11.1, 10.9, 10.9, 0, 10.8, 11.6, 11.1, 11.8, 11.4, 11.9, 7.1,
            10.8, 10.8, 11.9, 11.6, 11.9, 7.1, 10.8, 10.6, 9.6};

    public double[] mitsubishi_countryside = {0, 25, 25, 25.6, 25.6, 27, 25.6, 25.6, 26.3, 27, 15.4,
            15.4, 15.2, 15.2, 0, 16.9, 17.2, 14.9, 17.5, 15.2, 17.9, 11.2,
            16.9, 16.9, 17.9, 15.4, 17.9, 11.2, 16.9, 14.5, 13.5};

    public String[] isuzu = {"รุ่น", "D-MAX Cab4 1.9 Ddi S", "D-MAX Cab4 1.9 Ddi Z", "D-MAX Hi-Lander 2-Doors 1.9 Ddi L", "D-MAX Hi-Lander 2-Doors 1.9 Ddi X-Series", "D-MAX Hi-Lander 2-Doors 1.9 Ddi Z",
    ...
    public double[] isuzu_combined = {0, 15.9, 15.9, 15.9, 15.9, 15.9, 15.2, 15.9, 15.9, 15.2, 14.1,
    ...
    public double[] isuzu_town = {0, 12.8, 12.8, 12.8, 12.8, 12.8, 13.2, 12.8, 12.8, 13.2, 10.8,
    ...
    public double[] isuzu_countryside = {0, 18.5, 18.5, 18.5, 18.5, 18.5, 16.4, 18.5, 18.5, 16.4, 17.2,
    ...
    public String[] honda = {"รุ่น", "ACCORD 2.0 E", "ACCORD 2.0 EL", "ACCORD 2.4 EL", "ACCORD HYBRID", "ACCORD HYBRID TECH",
    ...
    public double[] honda_combined = {0, 12.8, 12.8, 12.2, 23.8, 23.8, 20, 20, 20, 16.4, 16.4,
    ...
    public double[] honda_town = {0, 8.9, 8.9, 8.3, 29.4, 29.4, 16.4, 16.4, 16.4, 13.3, 13.3,
    ...
    public double[] honda_countryside = {0, 16.9, 16.9, 16.7, 21.3, 21.3, 23.3, 23.3, 23.3, 18.9, 18.9,
    ...
    public String[] tata = {"รุ่น", "XENON 2.1L CNG SC CLE EIV 4X2 FLB HD", "XENON 2.2L DICOR DC DLS EIV 4X2 STY LD ABS AB", "XENON 2.2L DICOR DC DLS EIV 4X2 STY STD", "XENON 2.2L DICOR DC DLS EIV 4X4 STY LD ABS AB",
    ...
    public double[] tata_combined = {0, 11.6, 12.8, 12.8, 13.2, 13.2, 12.8, 12.8, 12.8, 12.8};

    public double[] tata_town = {0, 8.8, 10.3, 10, 10.8, 10.8, 10.3, 10, 10.3, 10};

    public double[] tata_countryside = {0, 14.1, 14.9, 15.4, 15.4, 15.4, 14.9, 15.4, 14.9, 15.4};


    public String[] foton = {"รุ่น", "Tunland DC 4x2 E", "Tunland DC 4x2 S", "Tunland DC 4x2 S Premium", "Tunland DC 4x4", "Tunland SC Flat Bed", "Tunland SC Standard"};

    public double[] foton_combined = {0, 13.7, 13.3, 13.3, 13.3, 13.7, 13.7};

    public double[] foton_town = {0, 13.2, 13, 13, 13, 13.2, 13.2};

    public double[] foton_countryside = {0, 13.9, 13.5, 13.5, 13.5, 13.9, 13.9};


    public String[] mini = {"รุ่น", "Cooper Countryman", "Cooper Countryman Hightrim", "Cooper D Countryman Hightrim", "Cooper SD ALL4 Countryman Park Lane Edition"};

    public double[] mini_combined = {0, 12, 12, 14.5, 14.3};

    public double[] mini_town = {0, 8.8, 8.8, 11, 10.8};

    public double[] mini_countryside = {0, 15.4, 15.4, 17.9, 17.9};


    public String[] mercedes_benz = {"รุ่น", "C 200", "C 200 Avantgarde", "C 250 Coupe AMG Dynamic", "C 250 Coupe Sport", "C 300 BlueTEC HYBRID", "CLA 200", "CLA 250", "E 200 Sedan", "E 220 d AMG Dynamic",
    ...
    public double[] mercedes_benz_combined = {0, 12.7, 16.1, 16.1, 16.4, 25, 16.4, 16.4, 12.7, 22.7,
            24.4, 22.7, 23.3, 14.3, 16.4, 15.6, 17.9, 17.9, 17.9, 14.7,
            13.3, 11.5};

    public double[] mercedes_benz_town = {0, 9.7, 12.2, 12.8, 13, 23.3, 12.7, 12.3, 9.1, 20.8,
            21.7, 20.8, 23.8, 9.9, 12.7, 11.9, 15.6, 15.2, 15.2, 11.9,
            9.9, 13.3};

    public double[] mercedes_benz_countryside = {0, 15.4, 19.6, 18.9, 19.2, 25, 19.6, 20.4, 16.4, 23.8,
            25.6, 23.8, 23.3, 18.9, 19.6, 18.9, 19.2, 19.6, 19.6, 16.9,
            16.4, 10.8};


    public String[] mg = {"รุ่น", "MG3 HATCHBACK 1.5 D", "GS 1.5T D 2WD", "GS 1.5T X 2WD", "GS 2.0T D 2WD", "GS 2.0T X AWD", "MG3 HATCHBACK 1.5 C", "MG3 HATCHBACK 1.5 V SUNROOF", "MG3 HATCHBACK 1.5 X SUNROOF", "MG3 XROSS 1.5 X SUNROOF",
    ...
    public double[] mg_combined = {0, 15.6, 15.6, 15.6, 12, 12, 15.6, 15.6, 15.6, 15.6,
            15.9, 15.9, 15.9, 15.9, 12.3, 12.3, 12.3, 12.3, 12.3, 12.3,
            12.3, 12.3, 12.3, 12.3};

    public double[] mg_town = {0, 12.3, 13.7, 13.7, 9, 9, 12.3, 12.3, 12.3, 12.3,
            11.6, 11.6, 10.9, 10.9, 8.8, 8.8, 8.8, 8.8, 8.8, 8.8,
            8.8, 8.8, 8.8, 8.8};

    public double[] mg_countryside = {0, 18.5, 17.2, 17.2, 15.2, 15.2, 18.5, 18.5, 18.5, 18.5,
